...
class SMARDDataLoader(TimeSeriesDataLoader):
    ...
    def preprocess_data(self) -> None:
        ...
        self.logger.info("Converting 'Datum' column to datetime format...")
        ...
        self.logger.info("Converted energy columns to float.")
    ...
    def validate_data(self) -> None:
        ...
        if not pd.api.types.is_datetime64_any_dtype(self.data['timestamp']):
            self.logger.warning("Column 'timestamp' is not in datetime format.")
